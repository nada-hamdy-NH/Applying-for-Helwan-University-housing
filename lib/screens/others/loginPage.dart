...
import 'package:mdina1/core/controllers/others/login/login_cubit.dart';
import 'package:mdina1/core/controllers/others/login/login_status.dart';
import 'package:mdina1/screens/others/profile.dart';
import 'package:mdina1/screens/others/updateProfile.dart';
import 'package:mdina1/screens/requestType.dart';
...
getDataFoeProfile(BuildContext context, String email, String password) async {
  ...
  if (res == 404) {
    ...
    if(dataRes!= null){
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Profile()), // Replace with your actual route
      );
  }
