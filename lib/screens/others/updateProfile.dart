...
import 'package:mdina1/screens/others/profile.dart';
...
class _UpdateStudentProfileState extends State<UpdateStudentProfile> {
  ...
  List<Map<String, dynamic>> getLevels(int collageId) {
    return levels.firstWhere(
        (element) => element['collage_id'] == collageId)['collage_levels'];
  }
  ...
  List<Map<String, dynamic>> getCities(int governorateId) {
    return city.firstWhere(
        (element) => element['governorate_id'] == governorateId)['cities'];
  }
        ...
        builder: (context, state) {
          ...
          return BlocConsumer<UpdateCubit, UpdateStatus>(
              ...
              builder: (context, state) {
                ...
                UpdateCubit.get(context).studentModelUpdate!.cityId =
                    getProfileCubit.newStudents!.student.cityId;
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    EditTextFiled(
                                      ...
                                      initialValue: getProfileCubit
                                          .newStudents!.student.nationalID,
                                      change: (value) {
                                        UpdateCubit.get(context)
                                            .studentModelUpdate
                                            ?.nationalID = value;
                                    ...
                                    EditTextFiled(
                                      ...
                                      initialValue: getProfileCubit
                                          .newStudents!.student.studentCode,
                                      change: (value) {
                                        UpdateCubit.get(context)
                                            .studentModelUpdate
                                            ?.studentCode = value;
                                    ...
                                    Container(
                                      ...
                                      child: DropdownButtonFormField<int>(
                                        ...
                                        value: getProfileCubit
                                            .newStudents!.student.governorateId,
                                    ...
                                    selectedGovernorate != null
                                        ...
                                        Container(
                                            ...
                                            child: DropdownButtonFormField<int>(
                                              ...
                                              value: getProfileCubit
                                                  .newStudents!.student.cityId,
                                              items: getCities(getProfileCubit
                                                      .newStudents!
                                                      .student
                                                      .governorateId)
                                                  .asMap()
                                    ...
                                    EditTextFiled(
                                      ...
                                      initialValue: getProfileCubit
                                          .newStudents!.student.phoneNumber,
                                      change: (value) {
                                        UpdateCubit.get(context)
                                            .studentModelUpdate
                                            ?.phoneNumber = value;
                                    ...
                                    EditTextFiled(
                                      ...
                                      initialValue: getProfileCubit
                                          .newStudents!.student.mobileNumber,
                                      change: (value) {
                                        UpdateCubit.get(context)
                                            .studentModelUpdate
                                            ?.mobileNumber = value;
                                    ...
                                    EditTextFiled(
                                      ...
                                      prefixIcon: const Icon(Icons.person),
                                      initialValue: getProfileCubit
                                          .newStudents!.student.fatherName,
                                      change: (value) {
                                        UpdateCubit.get(context)
                                            .studentModelUpdate
                                            ?.fatherName = value;
                                    ...
                                    EditTextFiled(
                                      ...
                                      prefixIcon: const Icon(
                                          Icons.phone_android_outlined),
                                      initialValue: getProfileCubit
                                          .newStudents!.student.fatherPhone,
                                      change: (value) {
                                        UpdateCubit.get(context)
                                            .studentModelUpdate
                                            ?.fatherphone = value;
                                    ...
                                    EditTextFiled(
                                      ...
                                      prefixIcon: const Icon(Icons.person),
                                      initialValue: getProfileCubit
                                          .newStudents!.student.guardianName,
                                      change: (value) {
                                        UpdateCubit.get(context)
                                            .studentModelUpdate
                                            ?.guardianName = value;
                                    ...
                                    Container(
                                      ...
                                      child: DropdownButtonFormField(
                                        ...
                                        value: getProfileCubit
                                            .newStudents!.student.parentsStatus,
                                        items: const <DropdownMenuItem<String>>[
                                          DropdownMenuItem<String>(
                                            value: 'Alive',
                                    ...
                                    EditDropDown(
                                      ...
                                      label2: 'لا',
                                      value2: 0,
                                      newValue: getProfileCubit
                                          .newStudents!.student.familyAbroad
                                          .toString(),
                                    ...
                                    selectedCollage != null
                                        ...
                                        : Container(
                                            ...
                                            child: DropdownButtonFormField<int>(
                                              ...
                                              value: getProfileCubit
                                                  .newStudents!.student.levelId,
                                              items: getLevels(getProfileCubit
                                                      .newStudents!
                                                      .student
                                                      .collegeId)
                                                  .asMap()
                                            ...
                                            children: [
                                              ...
                                              EditTextFiled(
                                                ...
                                                initialValue: getProfileCubit
                                                    ...
                                                    .toString(),
                                                controller:
                                                    '', //GetProfileCubit.get(context).newStudents!.newStudents![0].SecondaryEducationRate.toString(),
                                              )
                                            ],
                                          ),
                                    ...
                                    Container(
                                      ...
                                      child: DropdownButtonFormField<String>(
                                        ...
                                        value: getProfileCubit
                                            .newStudents!.student.housingType,
                                        items: const <DropdownMenuItem<String>>[
                                          DropdownMenuItem<String>(
                                            value: 'nonspecial',
                                            child: Text('عادى'),
                                    ...
                                    EditDropDown(
                                      ...
                                      value2: 0,
                                      newValue: getProfileCubit
                                          .newStudents!.student.specialNeed
                                          .toString(),
                                      changeDrop: (String? newValue) {
                                        setState(() {
                                    ...
                                    EditTextFiled(
                                      ...
                                      controller: "",
                                      prefixIcon: const Icon(Icons.password),
                                      initialValue: UpdateCubit.get(context)
                                              .studentModelUpdate!
                                              .confirmPassword =
  ...
  if (res == 200) {
    ...
    if (result == 200) {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                const Profile()), // Replace with your actual route
      );
    } else {
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => const Go()), // Replace with your actual route
      );
    }
  } else {
    Navigator.push(
...
withFood(context) {
  if (GetProfileCubit.get(context)
          .newStudents!
          .student
          .housingWithoutCatering ==
      1) {
    UpdateCubit.get(context).studentModelUpdate?.housingWithoutCatering = 1;
    return GetProfileCubit.get(context)
        .newStudents!
        .student
        .housingWithoutCatering
        .toString();
...
special(context) {
  if (GetProfileCubit.get(context).newStudents!.student.specialNeed == 1) {
    UpdateCubit.get(context).studentModelUpdate?.specialNeed = 1;
    return GetProfileCubit.get(context)
        .newStudents!
        .student
        .specialNeed
    ...
    UpdateCubit.get(context).studentModelUpdate?.specialNeed = 0;
    return GetProfileCubit.get(context)
        .newStudents!
        .student
        .specialNeed
...
List<Map<String, dynamic>> city = [
  ...
  ///3
  {
    ...
    'cities': [
      {"id": 93, "name": "ابو قير"},
      {"id": 94, "name": "الابراهيمية"},
      {"id": 95, "name": "الأزاريطة"},
      {"id": 96, "name": "الانفوشى"},
      {"id": 97, "name": "الدخيلة"},
      {"id": 98, "name": "السيوف"},
      {"id": 99, "name": "العامرية"},
      {"id": 100, "name": "اللبان"},
      {"id": 101, "name": "المفروزة"},
      {"id": 102, "name": "المنتزه"},
      {"id": 103, "name": "المنشية"},
      {"id": 104, "name": "الناصرية"},
      {"id": 105, "name": "امبروزو"},
      {"id": 106, "name": "باب شرق"},
      {"id": 107, "name": "برج العرب"},
      {"id": 108, "name": "ستانلى"},
      {"id": 109, "name": "سموحة"},
      {"id": 110, "name": "سيدى بشر"},
      {"id": 111, "name": "شدس"},
      {"id": 112, "name": "غيط العنب"},
      {"id": 113, "name": "فلمينج"},
      {"id": 114, "name": "فيكتوريا"},
      {"id": 115, "name": "كامب شيزار"},
      {"id": 116, "name": "كرموز"},
      {"id": 117, "name": "محطة الرمل"},
      {"id": 118, "name": "مينا البصل"},
      {"id": 119, "name": "العصافرة"},
      {"id": 120, "name": "العجمي"},
      {"id": 121, "name": "بكوس"},
      {"id": 122, "name": "بولكلي"},
      {"id": 123, "name": "كليوباترا"},
      {"id": 124, "name": "جليم"},
      {"id": 125, "name": "المعمورة"},
      {"id": 126, "name": "المندرة"},
      {"id": 127, "name": "محرم بك"},
      {"id": 128, "name": "الشاطبي"},
      {"id": 129, "name": "سيدي جابر"},
      {"id": 130, "name": "الساحل الشمالي"},
      {"id": 131, "name": "الحضرة"},
      {"id": 132, "name": "العطارين"},
      {"id": 133, "name": "سيدي كرير"},
      {"id": 134, "name": "الجمرك"},
      {"id": 135, "name": "المكس"},
      {"id": 136, "name": "مارينا"}
    ],
  ...
  ///4
  {
    "governorate_id": 4,
    'cities': [
      {"id": 137, "name": "المنصورة"},
      {"id": 138, "name": "طلخا"},
      {"id": 139, "name": "ميت غمر"},
      {"id": 140, "name": "دكرنس"},
      {"id": 141, "name": "أجا"},
      {"id": 142, "name": "منية النصر"},
      {"id": 143, "name": "السنبلاوين"},
      {"id": 144, "name": "الكردي"},
      {"id": 145, "name": "بني عبيد"},
      {"id": 146, "name": "المنزلة"},
      {"id": 147, "name": "تمي الأمديد"},
      {"id": 148, "name": "الجمالية"},
      {"id": 149, "name": "شربين"},
      {"id": 150, "name": "المطرية"},
      {"id": 151, "name": "بلقاس"},
      {"id": 152, "name": "ميت سلسيل"},
      {"id": 153, "name": "جمصة"},
      {"id": 154, "name": "محلة دمنة"},
      {"id": 155, "name": "نبروه"}
    ]
  },
  ...
  ///5
  {
    ...
    'cities': [
      {"id": 156, "name": "الغردقة"},
      {"id": 157, "name": "رأس غارب"},
      {"id": 158, "name": "سفاجا"},
      {"id": 159, "name": "القصير"},
      {"id": 160, "name": "مرسى علم"},
      {"id": 161, "name": "الشلاتين"},
      {"id": 162, "name": "حلايب"},
      {"id": 163, "name": "الدهار"}
    ]
  },
  ...
  ///6
  {
    ...
    'cities': [
      {"id": 164, "name": "دمنهور"},
      {"id": 165, "name": "كفر الدوار"},
      {"id": 166, "name": "رشيد"},
      {"id": 167, "name": "إدكو"},
      {"id": 168, "name": "أبو المطامير"},
      {"id": 169, "name": "أبو حمص"},
      {"id": 170, "name": "الدلنجات"},
      {"id": 171, "name": "المحمودية"},
      {"id": 172, "name": "الرحمانية"},
      {"id": 173, "name": "إيتاي البارود"},
      {"id": 174, "name": "حوش عيسى"},
      {"id": 175, "name": "شبراخيت"},
      {"id": 176, "name": "كوم حمادة"},
      {"id": 177, "name": "بدر"},
      {"id": 178, "name": "وادي النطرون"},
      {"id": 179, "name": "النوبارية الجديدة"},
      {"id": 180, "name": "النوبارية"}
    ]
  },
  ...
  ///7
  {
    ...
    'cities': [
      {"id": 181, "name": "الفيوم"},
      {"id": 182, "name": "الفيوم الجديدة"},
      {"id": 183, "name": "طامية"},
      {"id": 184, "name": "سنورس"},
      {"id": 185, "name": "إطسا"},
      {"id": 186, "name": "إبشواي"},
      {"id": 187, "name": "يوسف الصديق"},
      {"id": 188, "name": "الحادقة"},
      {"id": 189, "name": "اطسا"},
      {"id": 190, "name": "الجامعة"},
      {"id": 191, "name": "السيالة"}
  ...
  ///8
  {
    ...
    'cities': [
      {"id": 192, "name": "طنطا"},
      {"id": 193, "name": "المحلة الكبرى"},
      {"id": 194, "name": "كفر الزيات"},
      {"id": 195, "name": "زفتى"},
      {"id": 196, "name": "السنطة"},
      {"id": 197, "name": "قطور"},
      {"id": 198, "name": "بسيون"},
  ...
  ///9
  {
    "governorate_id": 9,
    'cities': [
      {"id": 200, "name": "الإسماعيلية"},
      {"id": 201, "name": "فايد"},
      {"id": 202, "name": "القنطرة شرق"},
      {"id": 203, "name": "القنطرة غرب"},
      {"id": 204, "name": "التل الكبير"},
      {"id": 205, "name": "أبو صوير"},
      {"id": 206, "name": "القصاصين الجديدة"},
      {"id": 207, "name": "نفيشة"},
      {"id": 208, "name": "الشيخ زايد"}
    ]
  },
  ...
  ///10
  {
    "governorate_id": 10,
    'cities': [
      {"id": 209, "name": "شبين الكوم"},
      {"id": 210, "name": "مدينة السادات"},
      {"id": 211, "name": "منوف"},
      {"id": 212, "name": "سرس الليان"},
      {"id": 213, "name": "أشمون"},
      {"id": 214, "name": "الباجور"},
      {"id": 215, "name": "قويسنا"},
      {"id": 216, "name": "بركة السبع"},
      {"id": 217, "name": "تلا"},
      {"id": 218, "name": "الشهداء"}
    ]
  },
  ...
  ///11
  {
    ...
    'cities': [
      {"id": 219, "name": "المنيا"},
      {"id": 220, "name": "المنيا الجديدة"},
      {"id": 221, "name": "العدوة"},
      {"id": 222, "name": "مغاغة"},
      {"id": 223, "name": "بني مزار"},
      {"id": 224, "name": "مطاي"},
      {"id": 225, "name": "سمالوط"},
      {"id": 226, "name": "المدينة الفكرية"},
      {"id": 227, "name": "ملوي"},
      {"id": 228, "name": "دير مواس"},
      {"id": 229, "name": "ابو قرقاص"},
      {"id": 230, "name": "ارض سلطان"}
    ]
  },
  ...
  ///12
  {
    ...
    'cities': [
      {"id": 231, "name": "بنها"},
      {"id": 232, "name": "قليوب"},
      {"id": 233, "name": "شبرا الخيمة"},
      {"id": 234, "name": "القناطر الخيرية"},
      {"id": 235, "name": "الخانكة"},
      {"id": 236, "name": "كفر شكر"},
      {"id": 237, "name": "طوخ"},
      {"id": 238, "name": "قها"},
  ...
  ///15
  {
    ...
    'cities': [
      {"id": 254, "name": "أسوان"},
      {"id": 255, "name": "أسوان الجديدة"},
      {"id": 256, "name": "دراو"},
      {"id": 257, "name": "كوم أمبو"},
      {"id": 258, "name": "نصر النوبة"},
      {"id": 259, "name": "كلابشة"},
      {"id": 260, "name": "إدفو"},
      {"id": 261, "name": "الرديسية"},
      {"id": 262, "name": "البصيلية"},
      {"id": 263, "name": "السباعية"},
      {"id": 264, "name": "ابوسمبل السياحية"},
      {"id": 265, "name": "مرسى علم"}
    ]
  },
  ...
  ///17
  {
    "governorate_id": 17,
    'cities': [
      {"id": 277, "name": "بني سويف"},
      {"id": 278, "name": "بني سويف الجديدة"},
      {"id": 279, "name": "الواسطى"},
      {"id": 280, "name": "ناصر"},
      {"id": 281, "name": "إهناسيا"},
      {"id": 282, "name": "ببا"},
  ...
  ///18
  {
    ...
    'cities': [
      ...
      {"id": 288, "name": "بورفؤاد"},
      {"id": 289, "name": "العرب"},
      {"id": 290, "name": "حى الزهور"},
      {"id": 291, "name": "حى الشرق"},
      {"id": 292, "name": "حى الضواحى"},
      {"id": 293, "name": "حى المناخ"},
      {"id": 294, "name": "حى مبارك"}
    ]
  },
  ...
  ///19
  {
    ...
    'cities': [
      {"id": 295, "name": "دمياط"},
      {"id": 296, "name": "دمياط الجديدة"},
      {"id": 297, "name": "رأس البر"},
      {"id": 298, "name": "فارسكور"},
      {"id": 299, "name": "الزرقا"},
      {"id": 300, "name": "السرو"},
      {"id": 301, "name": "الروضة"},
      {"id": 302, "name": "كفر البطيخ"},
      {"id": 303, "name": "عزبة البرج"},
      {"id": 304, "name": "ميت أبو غالب"},
      {"id": 305, "name": "كفر سعد"}
    ]
  },
  ...
  ///20
  {
    "governorate_id": 20,
    'cities': [
      {"id": 306, "name": "الزقازيق"},
      {"id": 307, "name": "العاشر من رمضان"},
      {"id": 308, "name": "منيا القمح"},
      {"id": 309, "name": "بلبيس"},
      {"id": 310, "name": "مشتول السوق"},
      {"id": 311, "name": "القنايات"},
      {"id": 312, "name": "أبو حماد"},
      {"id": 313, "name": "القرين"},
      {"id": 314, "name": "ههيا"},
      {"id": 315, "name": "أبو كبير"},
      {"id": 316, "name": "فاقوس"},
      {"id": 317, "name": "الصالحية الجديدة"},
      {"id": 318, "name": "الإبراهيمية"},
      {"id": 319, "name": "ديرب نجم"},
      {"id": 320, "name": "كفر صقر"},
      {"id": 321, "name": "أولاد صقر"},
      {"id": 322, "name": "الحسينية"},
      {"id": 323, "name": "صان الحجر القبلية"},
      {"id": 324, "name": "منشأة أبو عمر"}
    ]
  },
  ...
  ///21
  {
    ...
    'cities': [
      {"id": 325, "name": "الطور"},
      {"id": 326, "name": "شرم الشيخ"},
      {"id": 327, "name": "دهب"},
      {"id": 328, "name": "نويبع"},
      {"id": 329, "name": "طابا"},
      {"id": 330, "name": "سانت كاترين"},
      {"id": 331, "name": "أبو رديس"},
      {"id": 332, "name": "أبو زنيمة"},
      {"id": 333, "name": "رأس سدر"}
    ]
  },
  ...
  ///22
  {
    "governorate_id": 22,
    'cities': [
      {"id": 334, "name": "كفر الشيخ"},
      {"id": 335, "name": "وسط البلد كفر الشيخ"},
      {"id": 336, "name": "دسوق"},
      {"id": 337, "name": "فوه"},
      {"id": 338, "name": "مطوبس"},
      {"id": 339, "name": "برج البرلس"},
      {"id": 340, "name": "بلطيم"},
      {"id": 341, "name": "مصيف بلطيم"},
      {"id": 342, "name": "الحامول"},
      {"id": 343, "name": "بيلا"},
      {"id": 344, "name": "الرياض"},
      {"id": 345, "name": "سيدي سالم"},
      {"id": 346, "name": "قلين"},
      {"id": 347, "name": "سيدي غازي"}
    ]
  },
  ...
  ///23
  {
    "governorate_id": 23,
    'cities': [
      {"id": 348, "name": "مرسى مطروح"},
      {"id": 349, "name": "الحمام"},
      {"id": 350, "name": "العلمين"},
      {"id": 351, "name": "الضبعة"},
      {"id": 352, "name": "النجيلة"},
      {"id": 353, "name": "سيدي براني"},
      {"id": 354, "name": "السلوم"},
      {"id": 355, "name": "سيوة"},
      {"id": 356, "name": "مارينا"},
      {"id": 357, "name": "الساحل الشمالى"}
    ]
  },
  ...
  ///24
  {
    ...
    'cities': [
      {"id": 358, "name": "الأقصر"},
      {"id": 359, "name": "الأقصر الجديدة"},
      {"id": 360, "name": "إسنا"},
      {"id": 361, "name": "طيبة الجديدة"},
      {"id": 362, "name": "الزينية"},
      {"id": 363, "name": "البياضية"},
      {"id": 364, "name": "القرنة"},
      {"id": 365, "name": "أرمنت"},
      {"id": 366, "name": "الطود"}
    ]
  ...
  ///25
  {
    ...
    'cities': [
      {"id": 367, "name": "قنا"},
      {"id": 368, "name": "قنا الجديدة"},
      {"id": 369, "name": "ابو طشت"},
      {"id": 370, "name": "نجع حمادي"},
      {"id": 371, "name": "دشنا"},
      {"id": 372, "name": "الوقف"},
      {"id": 373, "name": "قفط"},
      {"id": 374, "name": "نقادة"},
  ...
  ///26
  {
    ...
    'cities': [
      {"id": 377, "name": "العريش"},
      {"id": 378, "name": "الشيخ زويد"},
      {"id": 379, "name": "نخل"},
      {"id": 380, "name": "رفح"},
      {"id": 381, "name": "بئر العبد"},
      {"id": 382, "name": "الحسنة"}
    ]
  },
