...
import 'package:mdina1/core/controllers/newStudent/request_form_controller/new_student_cubit.dart';
import 'package:mdina1/core/controllers/newStudent/request_form_controller/new_student_status.dart';
import 'package:mdina1/screens/others/loginPage.dart';
import 'package:mdina1/screens/requestConforim.dart';
...
import 'new_student/facultyNewStudent.dart';
import 'new_student/parentNewStudent.dart';
import 'new_student/requestNewStudent.dart';
import 'others/profile.dart';

class RequestNewStepper extends StatefulWidget {
  const RequestNewStepper({Key? key}) : super(key: key);

  @override
  State<RequestNewStepper> createState() => _RequestNewStepperState();
}

class _RequestNewStepperState extends State<RequestNewStepper> {
  int currentStep = 0;
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<NewStudentCubit, NewStudentStatus>(
...
getErrorMessage(context) async {
  final res = await NewStudentCubit.get(context).submitNewStudent();
  if (res == 200) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
      content: Text("الرجاء التاكد من ان الرقم القومى مطابق الى الباسورد"),
