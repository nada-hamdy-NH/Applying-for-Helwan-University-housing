...
import 'package:mdina1/network/remote/database_helper.dart';
...
const StudentInfo({Key? key, required this.formKey,}) : super(key: key);
...
class _StudentInfoState extends State<StudentInfo> {
  ...
  List<Map<String, dynamic>> getCities(int governorateId) {
    // Get the list of cities based on the selected governorateId.
    // Replace this with your actual logic to filter cities based on the governorateId.
    return city
  ...
  Future<void> _selectDate() async {
    ...
    if (_picker != null) {
      setState(() {
        ...
        OldStudentCubit.get(context).studentModel.birthDate  =birthdateController.text ;
      });
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            Radio(
                              ...
                              onChanged: (int? newValue) async {
                                setState(() {
                                  ...
                                  egyption = true;
                                  OldStudentCubit.get(context).studentModel.eygptian = egyption ;
                                });
                    ...
                    CustomTextFormField(
                      ...
                      onChanged: (p0) {
                      OldStudentCubit.get(context).studentModel.name = p0 ; 
                      },
                    ),
                    ...
                    CustomTextFormField(
                        ...
                        onChanged: (p0) {
                      OldStudentCubit.get(context).studentModel.nationalID= p0 ;
                      CacheHelper.saveData(key: "nationalId", value: p0);
                      },
                        ),
                    ...
                    CustomTextFormField(
                      ...
                      OldStudentCubit.get(context).studentModel.studentCode = p0 ; 
                      },
                    ...
                    CustomTextFormField(
                      ...
                      showInput: () {
                        print('birthday : ${birthdateController.text}');
                      },
                    ),
                      ...
                      child: DropdownButtonFormField(
                        ...
                        onChanged: (val) {
                          setState(() {
                            ...
                            OldStudentCubit.get(context).studentModel.gender = dropValue ; 
...
// hint:Text('الديانة'),
                        onChanged: (val) {
                          setState(() {
                            dropreligion = val as String;
                      OldStudentCubit.get(context).studentModel.religion = val ; 
                            print('religion : $dropreligion');
                          });
                        },
                        validator: (value) {
                          if (value == null || (value as String).isEmpty) {
                      ...
                      child: DropdownButtonFormField<int>(
                        ...
                        onChanged: (val) async {
                          setState(() {
                            ...
                            selectedCity = null; // Reset selected city when governorate changes.
                            OldStudentCubit.get(context).studentModel.governorateId = val; 
                            print("Governorate : $selectedGovernorate");  /// Governorate id
                          });
                        },
                        validator: (value) {
                          if (value == null) {
                    ...
                    CustomTextFormField(
                      ...
                      onChanged: (p0) {
                      OldStudentCubit.get(context).studentModel.address = p0 ; 
                      },
                    ...
                    CustomTextFormField(
                        ...
                        onChanged: (p0) {
                      OldStudentCubit.get(context).studentModel.phoneNumber = p0 ; 
                      },
                    ...
                    CustomTextFormField(
                      ...
                      onChanged: (p0) {
                      OldStudentCubit.get(context).studentModel.mobileNumber = p0 ; 
                      },),
  ...
  List<Map<String, dynamic>> city = [
    {
      "governorate_id": 1,  /// selected governorate
      'cities' : [
        {
          "id": 1,
          "name": "15 مايو",
